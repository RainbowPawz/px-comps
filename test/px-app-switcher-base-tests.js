...
function runBaseTests() {
  px_app_switcher_1 = document.getElementById('px_app_switcher_1');

  suite('Base Automation Tests for px-app-switcher', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('px-app-switcher fixture is created', function() {
      assert.isTrue(document.getElementById('px_app_switcher_1') !== null);
    });

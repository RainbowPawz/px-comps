...
function runBaseTests() {
  px_comp_1 = document.getElementById('px_comp_1');

  suite('Base Automation Tests for px-comp', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('px-comp fixture is created', function() {
      assert.isTrue(document.getElementById('px_comp_1') !== null);
    });
